...
Examples:
  ...
  curl -fsSL https://raw.githubusercontent.com/ntu254/Harness-Intelligence-OS/main/scripts/install-harness.sh | bash -s -- --yes
  curl -fsSL https://raw.githubusercontent.com/ntu254/Harness-Intelligence-OS/main/scripts/install-harness.sh | bash -s -- --merge --yes
  curl -fsSL https://raw.githubusercontent.com/ntu254/Harness-Intelligence-OS/main/scripts/install-harness.sh | bash -s -- --merge --refresh-agent-shim --yes
  curl -fsSL https://raw.githubusercontent.com/ntu254/Harness-Intelligence-OS/main/scripts/install-harness.sh | bash -s -- --claude --yes
EOF
}
...
default_cli_base_url() {
  ...
  if [ -n "$release_tag" ] && [ "$release_tag" != "latest" ]; then
    printf 'https://github.com/ntu254/Harness-Intelligence-OS/releases/download/%s\n' "$release_tag"
  else
    printf 'https://github.com/ntu254/Harness-Intelligence-OS/releases/latest/download\n'
  fi
}
...
SOURCE_ROOT=""
SOURCE_MODE="remote"
SOURCE_BASE_URL="${HARNESS_SOURCE_BASE_URL:-https://raw.githubusercontent.com/ntu254/Harness-Intelligence-OS/main}"
