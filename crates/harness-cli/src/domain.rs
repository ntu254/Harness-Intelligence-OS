...
pub struct ReleaseVerificationReport {
    ...
    pub payload_asset: Option<String>,
    pub payload_checksum_asset: Option<String>,
    pub payload_expected_hash: Option<String>,
    pub payload_actual_hash: Option<String>,
    pub payload_download: ReleaseCheckResult,
    pub payload_checksum: ReleaseCheckResult,
